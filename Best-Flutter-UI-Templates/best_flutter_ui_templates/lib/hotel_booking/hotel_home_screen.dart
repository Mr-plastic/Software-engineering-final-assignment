                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              return HotelListView(
                                callback: () async {
                                  await launchUrl(Uri.parse('https://www.google.com/search?q=${hotelList[index].titleTxt}'));
                                },
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                child: Padding(
                  ...
                  child: Icon(FontAwesomeIcons.magnifyingGlass, size: 20, color: HotelAppTheme.buildLightTheme().backgroundColor),
                ),
              ),
            ),
          ),
